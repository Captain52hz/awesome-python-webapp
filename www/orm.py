...
class StringField(Field):
	def __init__(self, name=None, ddl='varchar(1000)', primary_key=False, default=None):
...
class ModelMetaclass(type):
	def __new__(cls, name, bases, attrs):
		...
		attrs['__delete2__']='delete from `%s`'%tableName
		return type.__new__(cls, name, bases, attrs)
...
class Model(dict, metaclass=ModelMetaclass):
	...
	@classmethod
	async def delete(cls, pk=None):
		rs = await execute(cls.__delete2__)
